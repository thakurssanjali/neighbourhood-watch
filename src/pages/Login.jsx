...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      {/* ================= LOGIN SECTION ================= */}
      <section className="relative flex items-center justify-center w-full min-h-screen px-4 md:px-6 pt-20 md:pt-24 bg-fixed bg-center bg-cover"
        ...
        <div className="relative z-10 w-full max-w-md p-6 md:p-10 border shadow-2xl rounded-2xl md:rounded-3xl bg-white/95 backdrop-blur-xl border-white/20">
          {/* HEADER */}
          <div className="mb-6 md:mb-8 text-center">
            <h2 className="mb-2 text-3xl md:text-4xl font-black text-gray-900">Welcome Back</h2>
            <p className="text-xs md:text-base text-gray-600">Login to your ReportIT account</p>
          </div>
          ...
          <div className="flex justify-center gap-3 md:gap-4 mb-6 md:mb-8">
            {["user", "admin"].map((role) => (
              <button
                ...
                className={`px-4 md:px-6 py-2 rounded-full font-bold text-sm md:text-base capitalize transition-all ${loginRole === role
          ...
          {/* ERROR MESSAGE */}
          {error && (
            <div className="p-3 md:p-4 mb-4 md:mb-6 border border-red-200 rounded-lg bg-red-50">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 md:py-3 font-bold text-sm md:text-base text-white transition-all duration-300 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg"
            >
