...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      {/* ================= REGISTER SECTION ================= */}
      <section className="relative flex items-center justify-center w-full min-h-screen px-3 md:px-6 pt-24 md:pt-32 bg-fixed bg-center bg-cover"
        ...
        <div className="relative z-10 w-full max-w-2xl p-4 md:p-8 lg:p-10 rounded-2xl md:rounded-3xl shadow-2xl bg-white/95 backdrop-blur-xl border border-white/20">
          {/* HEADER */}
          <div className="mb-6 md:mb-8 text-center">
            <h2 className="mb-1 md:mb-2 text-2xl md:text-3xl lg:text-4xl font-black text-gray-900">Join Our Community</h2>
            <p className="text-xs md:text-sm lg:text-base text-gray-600">Create your ReportIT account today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 md:py-3 text-sm md:text-base font-bold text-white transition-all duration-300 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg"
            >
